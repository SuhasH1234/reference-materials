...
public class JdbcExample2 {	//insert users in database

	public static void main(String[] args) throws Exception {
		String url= "jdbc:mysql://localhost:3306/telusko";
		String uname= "root";
		String pass= "suhas";
		String query= "insert into users values (4, 'Harish')";	//insert query
		...
		int count= st.executeUpdate(query);	//execute the query -> insert = executeUpdate
